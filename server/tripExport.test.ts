...
describe("trip export", () => {
  it("exports operational columns with spreadsheet-safe Korean CSV content", () => {
    ...
    expect(csv).toContain(
      '"현장, 점검",2026-08-22,1,시청,"서울, 중구",37.5665,126.978,완료,2026-08-22T01:00:00.000Z,"안내판 ""훼손""",,,,조치 요청'
    );
  });

  it("round-trips exported destinations, including quoted multiline values", () => {
    const csv = makeTripStopsCsv("현장, 점검", "2026-08-22", [
      {
        sequence: 2,
        name: "구청",
